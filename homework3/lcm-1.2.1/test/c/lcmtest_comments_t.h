 ...
 */
lcmtest_comments_t* lcmtest_comments_t_copy(const lcmtest_comments_t* to_copy);

/**
 * Destroy an instance of lcmtest_comments_t created by lcmtest_comments_t_copy()
 */
void lcmtest_comments_t_destroy(lcmtest_comments_t* to_destroy);
 ...
 */
typedef void(*lcmtest_comments_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcmtest_comments_t *msg, void *userdata);
 ...
 */
int lcmtest_comments_t_publish(lcm_t *lcm, const char *channel, const lcmtest_comments_t *msg);
 ...
 */
lcmtest_comments_t_subscription_t* lcmtest_comments_t_subscribe(lcm_t *lcm, const char *channel, lcmtest_comments_t_handler_t handler, void *userdata);
 ...
 */
int lcmtest_comments_t_decode(const void *buf, int offset, int maxlen, lcmtest_comments_t *msg);
