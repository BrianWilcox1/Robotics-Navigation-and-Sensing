...
#ifndef _lcmtest_node_t_h
#define _lcmtest_node_t_h
 ...
 */
typedef struct _lcmtest_node_t lcmtest_node_t;
struct _lcmtest_node_t
{
    int32_t    num_children;
    lcmtest_node_t *children;
};

/**
 * Create a deep copy of a lcmtest_node_t.
 * When no longer needed, destroy it with lcmtest_node_t_destroy()
 */
lcmtest_node_t* lcmtest_node_t_copy(const lcmtest_node_t* to_copy);

/**
 * Destroy an instance of lcmtest_node_t created by lcmtest_node_t_copy()
 */
void lcmtest_node_t_destroy(lcmtest_node_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _lcmtest_node_t_subscription_t lcmtest_node_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * lcmtest_node_t is received.
 */
typedef void(*lcmtest_node_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcmtest_node_t *msg, void *userdata);

/**
 * Publish a message of type lcmtest_node_t using LCM.
 *
 ...
 */
int lcmtest_node_t_publish(lcm_t *lcm, const char *channel, const lcmtest_node_t *msg);

/**
 * Subscribe to messages of type lcmtest_node_t using LCM.
 *
 ...
 */
lcmtest_node_t_subscription_t* lcmtest_node_t_subscribe(lcm_t *lcm, const char *channel, lcmtest_node_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by lcmtest_node_t_subscribe()
 */
...
/**
 * Encode a message of type lcmtest_node_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to lcmtest_node_t_encoded_size().
...
/**
 * Decode a message of type lcmtest_node_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with lcmtest_node_t_decode_cleanup().
 *
 ...
 */
int lcmtest_node_t_decode(const void *buf, int offset, int maxlen, lcmtest_node_t *msg);

/**
 * Release resources allocated by lcmtest_node_t_decode()
 * @return 0
 */
int lcmtest_node_t_decode_cleanup(lcmtest_node_t *p);

/**
 * Check how many bytes are required to encode a message of type lcmtest_node_t
 */
