...
static int64_t __lcmtest2_cross_package_t_hash;
...
int64_t __lcmtest2_cross_package_t_hash_recursive(const __lcm_hash_ptr *p)
{
    ...
    __lcm_hash_ptr cp;
    cp.parent =  p;
    cp.v = (void*)__lcmtest2_cross_package_t_get_hash;
    (void) cp;

    int64_t hash = (int64_t)0xbbd3dd8a23ec1955LL
...
int64_t __lcmtest2_cross_package_t_get_hash(void)
{
    if (!__lcmtest2_cross_package_t_hash_computed) {
        __lcmtest2_cross_package_t_hash = __lcmtest2_cross_package_t_hash_recursive(NULL);
