 ...
 */
lcmtest_primitives_t* lcmtest_primitives_t_copy(const lcmtest_primitives_t* to_copy);

/**
 * Destroy an instance of lcmtest_primitives_t created by lcmtest_primitives_t_copy()
 */
void lcmtest_primitives_t_destroy(lcmtest_primitives_t* to_destroy);
 ...
 */
typedef void(*lcmtest_primitives_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcmtest_primitives_t *msg, void *userdata);
 ...
 */
int lcmtest_primitives_t_publish(lcm_t *lcm, const char *channel, const lcmtest_primitives_t *msg);
 ...
 */
lcmtest_primitives_t_subscription_t* lcmtest_primitives_t_subscribe(lcm_t *lcm, const char *channel, lcmtest_primitives_t_handler_t handler, void *userdata);
 ...
 */
int lcmtest_primitives_t_decode(const void *buf, int offset, int maxlen, lcmtest_primitives_t *msg);
