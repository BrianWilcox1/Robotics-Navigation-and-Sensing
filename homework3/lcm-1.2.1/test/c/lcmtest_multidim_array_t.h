...
#ifndef _lcmtest_multidim_array_t_h
#define _lcmtest_multidim_array_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _lcmtest_multidim_array_t lcmtest_multidim_array_t;
struct _lcmtest_multidim_array_t
{
    int32_t    size_a;
    int32_t    size_b;
    int32_t    size_c;
...
/**
 * Create a deep copy of a lcmtest_multidim_array_t.
 * When no longer needed, destroy it with lcmtest_multidim_array_t_destroy()
 */
lcmtest_multidim_array_t* lcmtest_multidim_array_t_copy(const lcmtest_multidim_array_t* to_copy);

/**
 * Destroy an instance of lcmtest_multidim_array_t created by lcmtest_multidim_array_t_copy()
 */
void lcmtest_multidim_array_t_destroy(lcmtest_multidim_array_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _lcmtest_multidim_array_t_subscription_t lcmtest_multidim_array_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * lcmtest_multidim_array_t is received.
 */
typedef void(*lcmtest_multidim_array_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcmtest_multidim_array_t *msg, void *userdata);

/**
 * Publish a message of type lcmtest_multidim_array_t using LCM.
 *
 ...
 */
int lcmtest_multidim_array_t_publish(lcm_t *lcm, const char *channel, const lcmtest_multidim_array_t *msg);

/**
 * Subscribe to messages of type lcmtest_multidim_array_t using LCM.
 *
 ...
 */
lcmtest_multidim_array_t_subscription_t* lcmtest_multidim_array_t_subscribe(lcm_t *lcm, const char *channel, lcmtest_multidim_array_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by lcmtest_multidim_array_t_subscribe()
 */
...
/**
 * Encode a message of type lcmtest_multidim_array_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to lcmtest_multidim_array_t_encoded_size().
...
/**
 * Decode a message of type lcmtest_multidim_array_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with lcmtest_multidim_array_t_decode_cleanup().
 *
 ...
 */
int lcmtest_multidim_array_t_decode(const void *buf, int offset, int maxlen, lcmtest_multidim_array_t *msg);

/**
 * Release resources allocated by lcmtest_multidim_array_t_decode()
 * @return 0
 */
int lcmtest_multidim_array_t_decode_cleanup(lcmtest_multidim_array_t *p);

/**
 * Check how many bytes are required to encode a message of type lcmtest_multidim_array_t
 */
