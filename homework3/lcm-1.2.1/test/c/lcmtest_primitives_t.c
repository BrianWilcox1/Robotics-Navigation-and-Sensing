...
static int __lcmtest_primitives_t_hash_computed;
static int64_t __lcmtest_primitives_t_hash;

int64_t __lcmtest_primitives_t_hash_recursive(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for (fp = p; fp != NULL; fp = fp->parent)
        if (fp->v == __lcmtest_primitives_t_get_hash)
            return 0;

    __lcm_hash_ptr cp;
    cp.parent =  p;
    cp.v = (void*)__lcmtest_primitives_t_get_hash;
    (void) cp;

    int64_t hash = (int64_t)0xc2731598914f36aaLL
...
int64_t __lcmtest_primitives_t_get_hash(void)
{
    if (!__lcmtest_primitives_t_hash_computed) {
        __lcmtest_primitives_t_hash = __lcmtest_primitives_t_hash_recursive(NULL);
        __lcmtest_primitives_t_hash_computed = 1;
    }

    return __lcmtest_primitives_t_hash;
}

int __lcmtest_primitives_t_encode_array(void *buf, int offset, int maxlen, const lcmtest_primitives_t *p, int elements)
{
...
int lcmtest_primitives_t_encode(void *buf, int offset, int maxlen, const lcmtest_primitives_t *p)
{
    int pos = 0, thislen;
    int64_t hash = __lcmtest_primitives_t_get_hash();

    thislen = __int64_t_encode_array(buf, offset + pos, maxlen - pos, &hash, 1);
    if (thislen < 0) return thislen; else pos += thislen;

    thislen = __lcmtest_primitives_t_encode_array(buf, offset + pos, maxlen - pos, p, 1);
    if (thislen < 0) return thislen; else pos += thislen;

    return pos;
}

int __lcmtest_primitives_t_encoded_array_size(const lcmtest_primitives_t *p, int elements)
{
    int size = 0, element;
    for (element = 0; element < elements; element++) {
...
int lcmtest_primitives_t_encoded_size(const lcmtest_primitives_t *p)
{
    return 8 + __lcmtest_primitives_t_encoded_array_size(p, 1);
}

int __lcmtest_primitives_t_decode_array(const void *buf, int offset, int maxlen, lcmtest_primitives_t *p, int elements)
{
    int pos = 0, thislen, element;
...
int __lcmtest_primitives_t_decode_array_cleanup(lcmtest_primitives_t *p, int elements)
{
    int element;
    for (element = 0; element < elements; element++) {
...
int lcmtest_primitives_t_decode(const void *buf, int offset, int maxlen, lcmtest_primitives_t *p)
{
    int pos = 0, thislen;
    int64_t hash = __lcmtest_primitives_t_get_hash();
    ...
    thislen = __lcmtest_primitives_t_decode_array(buf, offset + pos, maxlen - pos, p, 1);
    if (thislen < 0) return thislen; else pos += thislen;

    return pos;
}

int lcmtest_primitives_t_decode_cleanup(lcmtest_primitives_t *p)
{
    return __lcmtest_primitives_t_decode_array_cleanup(p, 1);
}

int __lcmtest_primitives_t_clone_array(const lcmtest_primitives_t *p, lcmtest_primitives_t *q, int elements)
{
    int element;
    for (element = 0; element < elements; element++) {
...
lcmtest_primitives_t *lcmtest_primitives_t_copy(const lcmtest_primitives_t *p)
{
    lcmtest_primitives_t *q = (lcmtest_primitives_t*) malloc(sizeof(lcmtest_primitives_t));
    __lcmtest_primitives_t_clone_array(p, q, 1);
    return q;
}

void lcmtest_primitives_t_destroy(lcmtest_primitives_t *p)
{
    __lcmtest_primitives_t_decode_array_cleanup(p, 1);
    free(p);
}

int lcmtest_primitives_t_publish(lcm_t *lc, const char *channel, const lcmtest_primitives_t *p)
{
      int max_data_size = lcmtest_primitives_t_encoded_size (p);
      uint8_t *buf = (uint8_t*) malloc (max_data_size);
      if (!buf) return -1;
      int data_size = lcmtest_primitives_t_encode (buf, 0, max_data_size, p);
      if (data_size < 0) {
          free (buf);
          return data_size;
      }
...
struct _lcmtest_primitives_t_subscription_t {
    lcmtest_primitives_t_handler_t user_handler;
    void *userdata;
    lcm_subscription_t *lc_h;
};
static
void lcmtest_primitives_t_handler_stub (const lcm_recv_buf_t *rbuf,
                            const char *channel, void *userdata)
{
    int status;
    lcmtest_primitives_t p;
    memset(&p, 0, sizeof(lcmtest_primitives_t));
    status = lcmtest_primitives_t_decode (rbuf->data, 0, rbuf->data_size, &p);
    if (status < 0) {
        fprintf (stderr, "error %d decoding lcmtest_primitives_t!!!\n", status);
        return;
    }

    lcmtest_primitives_t_subscription_t *h = (lcmtest_primitives_t_subscription_t*) userdata;
    h->user_handler (rbuf, channel, &p, h->userdata);

    lcmtest_primitives_t_decode_cleanup (&p);
}

lcmtest_primitives_t_subscription_t* lcmtest_primitives_t_subscribe (lcm_t *lcm,
                    const char *channel,
                    lcmtest_primitives_t_handler_t f, void *userdata)
{
    lcmtest_primitives_t_subscription_t *n = (lcmtest_primitives_t_subscription_t*)
                       malloc(sizeof(lcmtest_primitives_t_subscription_t));
    n->user_handler = f;
    n->userdata = userdata;
    n->lc_h = lcm_subscribe (lcm, channel,
                                 lcmtest_primitives_t_handler_stub, n);
    if (n->lc_h == NULL) {
        fprintf (stderr,"couldn't reg lcmtest_primitives_t LCM handler!\n");
        free (n);
        return NULL;
    }
    return n;
...
int lcmtest_primitives_t_subscription_set_queue_capacity (lcmtest_primitives_t_subscription_t* subs,
                              int num_messages)
{
    return lcm_subscription_set_queue_capacity (subs->lc_h, num_messages);
}

int lcmtest_primitives_t_unsubscribe(lcm_t *lcm, lcmtest_primitives_t_subscription_t* hid)
{
    int status = lcm_unsubscribe (lcm, hid->lc_h);
    if (0 != status) {
        fprintf(stderr,
           "couldn't unsubscribe lcmtest_primitives_t_handler %p!\n", hid);
        return -1;
    }
    free (hid);
    return 0;
