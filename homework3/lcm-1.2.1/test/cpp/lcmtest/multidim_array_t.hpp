...
int multidim_array_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    for (int a0 = 0; a0 < 2; a0++) {
        for (int a1 = 0; a1 < this->size_c; a1++) {
            char* __cstr = (char*) this->strarray[a0][a1].c_str();
...
int multidim_array_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    for (int a0 = 0; a0 < 2; a0++) {
        ...
        for (int a1 = 0; a1 < this->size_c; a1++) {
            ...
            this->strarray[a0][a1].assign(((const char*)buf) + offset + pos, __elem_len -  1);
            pos += __elem_len;
        }
    }
...
int64_t multidim_array_t::_computeHash(const __lcm_hash_ptr *)
{
    int64_t hash = 0x1e012473deb4cfbbLL;
